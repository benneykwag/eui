...
folder are mapped to the application's root namespace, 'Eui.sample'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Eui.sample' in the same way
as `"Eui.sample/sass/src"`.
