...
Ext.define('eui.Config', {
    ...
    data: {
        message : [
            ...
            {"MSG_ID": "행추가", "MSG_LABEL": "신규"},
            {"MSG_ID": "행추가아이콘", "MSG_LABEL": "x-fa fa-plus"},
            {"MSG_ID": "행삭제", "MSG_LABEL": "삭제"},
            {"MSG_ID": "행삭제아이콘", "MSG_LABEL": "x-fa fa-trash-o"},
            ...
            {"MSG_ID": "새로고침", "MSG_LABEL": "새로고침"},
            {"MSG_ID": "새로고침아이콘", "MSG_LABEL": "x-fa fa-refresh"},
            {"MSG_ID": "인쇄", "MSG_LABEL": "인쇄"},
            {"MSG_ID": "인쇄아이콘", "MSG_LABEL": "x-fa fa-print"},
            {"MSG_ID": "닫기", "MSG_LABEL": "닫기"},
            {"MSG_ID": "닫기아이콘", "MSG_LABEL": "x-fa fa-sign-out"},
